...
class Mesh : public ntp::MeshTime, public plugin::PackageHandler<T> {
 public:
   ...
   * \endcode
   */
  void onReceive(receivedCallback_t const& onReceive) {
   ...
   * \endcode
   */
  void onNewConnection(newConnectionCallback_t const& onNewConnection) {
   ...
   * \endcode
   */
  void onDroppedConnection(droppedConnectionCallback_t const& onDroppedConnection) {
   ...
   * \endcode
   */
  void onChangedConnections(changedConnectionsCallback_t const& onChangedConnections) {
   ...
   * \endcode
   */
  void onNodeTimeAdjusted(nodeTimeAdjustedCallback_t const& onTimeAdjusted) {
   ...
   * \endcode
   */
  void onNodeDelayReceived(nodeDelayCallback_t const& onDelayReceived) {
